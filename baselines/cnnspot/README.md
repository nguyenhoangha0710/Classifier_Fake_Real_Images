# CNNSpot reproduction

Thư mục này chứa notebook riêng cho baseline `cnnspot`.
...
Notebook này chỉ train và đánh giá model `cnnspot`.
...
- `MODEL_NAME`: đã preset là `cnnspot`.
